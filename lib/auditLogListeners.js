...
function registerAuditLogListeners(client) {
    ...
    client.on(Events.MessageDelete, async (message) => {
        ...
        await record('messages', guildId, {
            ...
            summary: `Message deleted in ${channelDisplay(resolved?.channel)}`,
    ...
    client.on(Events.MessageUpdate, async (oldMessage, newMessage) => {
        ...
        await record('messages', guildId, {
            type: 'MESSAGE_EDITED',
            summary: `Message edited in ${channelDisplay(after?.channel || before?.channel)}`,
    ...
    client.on(Events.InviteCreate, async (invite) => {
        await record('invites', invite.guild?.id, {
            type: 'INVITE_CREATED',
            summary: `Invite created in ${channelDisplay(invite.channel)} with code ${invite.code}`,
